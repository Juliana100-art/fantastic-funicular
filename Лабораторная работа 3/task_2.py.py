...
def find_common_paticipants(participants1, participants2, separator=","):
...
participants = find_common_paticipants(participants_first_group, participants_second_group)
